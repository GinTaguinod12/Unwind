...
public class EmotionSliderView extends View {
    ...
    private int[] emotionDrawables;  // Array to hold drawable resource IDs

    private float currentPosition = 2.5f; // Start at middle, if 3 then 3rd button and so on
    ...
    private void init() {
        ...
        selectedThumbPaint.setColor(emotionColors[2]); // Start with displaying mood 3
